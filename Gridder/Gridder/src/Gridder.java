...
public class Gridder extends javax.swing.JFrame 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed=
        //selecting random location and turn that square to white.
        //repeating this 100 times
        System.out.println("1");
        Random random = new Random();
        for (int i = 0; i < 100; i++){
            int randomRow1 = random.nextInt(100);
            int randomCol1 = random.nextInt(100);

            grid[randomCol1][randomRow1] = 1;
            draw();
        }
        //draw();
    }//GEN-LAST:event_jButton1ActionPerformed
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //selecting a random column. Then, set all the squares in that column to white.
        System.out.println("2");
        Random random2 = new Random();
        int randomCol2 = random2.nextInt(100);
        for (int i = 0; i < 100; i++){
            grid[randomCol2][i] = 1;
            draw();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //colour the entire top half to white and the entire bottom to black.
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //clear the grid and then create a white X
        System.out.println("5");
        int positionOfBottom = 99;
        clearGrid();
        for (int i = 0; i < 100; i++){
            grid[i][i] = 1;
            grid[i][positionOfBottom - i] = 1;
        }
        draw();
    }//GEN-LAST:event_jButton11ActionPerformed
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //inverse the grid colours.
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //any black square touching TWO white squares will turn to white.
        System.out.println("7");
        int whiteBlockCount = 0;

        int[][] storedInfo = new int[100][100];
        for (int i = 0; i < 100; i++){
            for (int j = 0; j < 100; j++){
                storedInfo[j][i] = grid[j][i];
            }
        }
        ...
        for (int i = 0; i < 100; i++){
            for (int j = 0; j < 100; j++){
                ...
                //to color the bottom left corner
                if (j == 0 && i == 99){
                    if (grid[0][98] == 1){
                        whiteBlockCount++;
                    }
                ...
                //to color the bottom right corner
                if (j == 99 && i == 99){
                    if (grid[99][98] == 1){
                        whiteBlockCount++;
                    }
                ...
                //to color the right edge of the grid
                if (j == 99 && i > 0 && i < 99){
                    if (grid[99][i - 1] == 1){
                        whiteBlockCount++;
                    }
                ...
                //to color the up edge of the grid
                if (j > 0 && j < 99 && i == 0){
                    if (grid[j - 1][0] == 1){
                        whiteBlockCount++;
                    }
                ...
                //to color the bottom edge of the grid
                if (j > 0 && j < 99 && i == 99){
                    if (grid[j - 1][99] == 1){
                        whiteBlockCount++;
                    }
                ...
                //to color the rest part of the grid
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //all squares will move one position to the left.
        //the leftmost column will become the rightmost column.
        System.out.println("8");
        /**
         * copying the grid information to the other 2D array.
         */
        int [][] storeInfo = new int[100][100];
        for (int i = 0; i < 100; i++){
            for (int j = 0; j < 100; j++){
                storeInfo[i][j] = grid[i][j];
                grid[i][j] = 0;
            }
        }

        /**
         * transporting the information that is stored in the "storeInfo" array.
         */
        for (int i = 0; i <= 99; i++){
            for (int j = 0; j < 100; j++){
                if (i == 99){
                    grid[0][j] = storeInfo[i][j];
                }
                else {
                    grid[i + 1][j] = storeInfo[i][j];
                }
            }
        }
        draw();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        /**
         * store the information from left to right, top to bottom.
         */
        int [][] storedInfo = new int[100][100];
        for (int i = 0; i < 100; i++){
            for (int j = 0; j < 100; j++){
        ...
        /**
         * get the information from "storedInfo" and put it from right to left, top to bottom.
         */
        //number for columns of storeInfo
        int num = 0;
        for (int i = 99; i >= 0; i--){
            for (int j = 0; j < 100; j++){
                grid[i][j] = storedInfo[j][num];
            }
            num++;
        }
        draw();
